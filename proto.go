...
//go:generate protoc -I . -I third_party --gotag_out=paths=source_relative:. --gotag_opt=Mapi/orchestrator/orchestrator.proto=clouditor.io/api/orchestrator api/orchestrator/orchestrator.proto
