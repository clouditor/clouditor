...
// Run owl2proto to generate the ontology proto file. The tool needs as arguments the following:
...
//go:generate owl2proto internal/input/urn_webprotege_ontology_e4316a28-d966-4499-bd93-6be721055117.owx internal/input/clouditor_header.proto http://graph.clouditor.io/classes/CloudResource api/ontology/ontology.proto
//go:generate buf format -w
//go:generate buf generate --exclude-path="internal/input/clouditor_header.proto"
//go:generate buf generate --exclude-path="internal/input/clouditor_header.proto" --template buf.gotag.gen.yaml
