...
func BindFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String(config.CertificationTargetIDFlag, config.DefaultCertificationTargetID, "Specifies the Cloud Service ID")
	...
	_ = viper.BindPFlag(config.CertificationTargetIDFlag, cmd.Flags().Lookup(config.CertificationTargetIDFlag))
