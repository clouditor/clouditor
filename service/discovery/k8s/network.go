...
func NewKubernetesNetworkDiscovery(intf kubernetes.Interface, CertificationTargetID string) discovery.Discoverer {
	return &k8sNetworkDiscovery{k8sDiscovery{intf, CertificationTargetID}}
}
