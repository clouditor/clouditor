...
func (d *csafDiscovery) documentChecksums(file csaf.AdvisoryFile, body []byte) (checksums []*ontology.CryptographicHash) {
...
func (d *csafDiscovery) documentChecksum(checksumURL, filename string, body []byte, algorithm string, h hash.Hash) *ontology.CryptographicHash {
