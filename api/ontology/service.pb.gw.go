...
func RegisterOntologyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OntologyServiceServer) error {
	mux.Handle(http.MethodPost, pattern_OntologyService_Noop_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
