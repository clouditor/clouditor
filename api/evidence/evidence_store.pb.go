...
var file_api_evidence_evidence_store_proto_rawDesc = []byte{
	...
	0x22, 0x3f, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x45, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x0b, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e,
...
var file_api_evidence_evidence_store_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_evidence_evidence_store_proto_goTypes = []interface{}{
	...
	(*GetEvidenceRequest)(nil),     // 5: clouditor.evidence.v1.GetEvidenceRequest
	(*Evidence)(nil),               // 6: clouditor.evidence.v1.Evidence
}
var file_api_evidence_evidence_store_proto_depIdxs = []int32{
	6, // 0: clouditor.evidence.v1.StoreEvidenceRequest.evidence:type_name -> clouditor.evidence.v1.Evidence
	6, // 1: clouditor.evidence.v1.ListEvidencesResponse.evidences:type_name -> clouditor.evidence.v1.Evidence
	...
	5, // 5: clouditor.evidence.v1.EvidenceStore.GetEvidence:input_type -> clouditor.evidence.v1.GetEvidenceRequest
	1, // 6: clouditor.evidence.v1.EvidenceStore.StoreEvidence:output_type -> clouditor.evidence.v1.StoreEvidenceResponse
	2, // 7: clouditor.evidence.v1.EvidenceStore.StoreEvidences:output_type -> clouditor.evidence.v1.StoreEvidencesResponse
	4, // 8: clouditor.evidence.v1.EvidenceStore.ListEvidences:output_type -> clouditor.evidence.v1.ListEvidencesResponse
	6, // 9: clouditor.evidence.v1.EvidenceStore.GetEvidence:output_type -> clouditor.evidence.v1.Evidence
