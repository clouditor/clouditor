...
type Evidence struct {
	...
	ApplicableMetrics []string `protobuf:"bytes,5,rep,name=applicable_metrics,json=applicableMetrics,proto3" json:"applicable_metrics,omitempty"`
...
func (x *Evidence) GetApplicableMetrics() []string {
	if x != nil {
...
func (x *Evidence) GetResource() string {
	if x != nil {
		return x.Resource
	}
	return ""
...
type Metric struct {
	...
	// target value
	//
	// Types that are assignable to TargetValue:
	//	*Metric_NumericTargetValue
	//	*Metric_StringTargetValue
	TargetValue isMetric_TargetValue `protobuf_oneof:"target_value"`
}
...
func (m *Metric) GetTargetValue() isMetric_TargetValue {
	if m != nil {
...
func (x *Metric) GetNumericTargetValue() int64 {
	if x, ok := x.GetTargetValue().(*Metric_NumericTargetValue); ok {
		return x.NumericTargetValue
	}
	return 0
}

func (x *Metric) GetStringTargetValue() string {
	if x, ok := x.GetTargetValue().(*Metric_StringTargetValue); ok {
		return x.StringTargetValue
	}
	return ""
}

type isMetric_TargetValue interface {
	isMetric_TargetValue()
}

type Metric_NumericTargetValue struct {
	NumericTargetValue int64 `protobuf:"varint,10,opt,name=numeric_target_value,json=numericTargetValue,proto3,oneof"`
}

type Metric_StringTargetValue struct {
	StringTargetValue string `protobuf:"bytes,11,opt,name=string_target_value,json=stringTargetValue,proto3,oneof"`
}

func (*Metric_NumericTargetValue) isMetric_TargetValue() {}

func (*Metric_StringTargetValue) isMetric_TargetValue() {}
...
func (x *Range) GetAllowedValuesRange() *AllowedValues {
	if x, ok := x.GetRange().(*Range_AllowedValuesRange); ok {
		return x.AllowedValuesRange
	}
	return nil
}
...
func (x *Range) GetMinMaxRange() *MinMax {
	if x, ok := x.GetRange().(*Range_MinMaxRange); ok {
		return x.MinMaxRange
	}
	return nil
}
...
type Range_AllowedValuesRange struct {
	// used for nomical scale
	AllowedValuesRange *AllowedValues `protobuf:"bytes,1,opt,name=allowed_values_range,json=allowedValuesRange,proto3,oneof"`
}
...
type Range_MinMaxRange struct {
	// used for metric scale
	MinMaxRange *MinMax `protobuf:"bytes,3,opt,name=min_max_range,json=minMaxRange,proto3,oneof"`
}

func (*Range_AllowedValuesRange) isRange_Range() {}

func (*Range_Order) isRange_Range() {}

func (*Range_MinMaxRange) isRange_Range() {}
...
func (x *AllowedValues) GetValues() []string {
	if x != nil {
		return x.Values
	}
	return nil
...
var file_evidence_proto_rawDesc = []byte{
	...
	0x12, 0x09, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x69, 0x74, 0x6f, 0x72, 0x22, 0xd5, 0x01, 0x0a, 0x08,
	...
	,
	...
	,
	...
	0x03, 0x6d, 0x61, 0x78, 0x22, 0x27, 0x0a, 0x0d, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x1f, 0x0a,
	0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x42, 0x10,
...
var file_evidence_proto_depIdxs = []int32{
	...
	5, // 2: clouditor.Range.allowed_values_range:type_name -> clouditor.AllowedValues
	6, // 3: clouditor.Range.order:type_name -> clouditor.Order
	4, // 4: clouditor.Range.min_max_range:type_name -> clouditor.MinMax
...
func file_evidence_proto_init() {
	...
	file_evidence_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Metric_NumericTargetValue)(nil),
		(*Metric_StringTargetValue)(nil),
	}
	file_evidence_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*Range_AllowedValuesRange)(nil),
		(*Range_Order)(nil),
		(*Range_MinMaxRange)(nil),
	}
	type x struct{}
