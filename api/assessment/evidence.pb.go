...
type Metric struct {
	...
	//	*Metric_TargetValueNum
	//	*Metric_TargetValueString
...
func (x *Metric) GetTargetValueNum() int64 {
	if x, ok := x.GetTargetValue().(*Metric_TargetValueNum); ok {
		return x.TargetValueNum
	}
	return 0
}

func (x *Metric) GetTargetValueString() string {
	if x, ok := x.GetTargetValue().(*Metric_TargetValueString); ok {
		return x.TargetValueString
	}
	return ""
}
...
type Metric_TargetValueNum struct {
	TargetValueNum int64 `protobuf:"varint,10,opt,name=target_value_num,json=targetValueNum,proto3,oneof"`
}

type Metric_TargetValueString struct {
	TargetValueString string `protobuf:"bytes,11,opt,name=target_value_string,json=targetValueString,proto3,oneof"`
}

func (*Metric_TargetValueNum) isMetric_TargetValue() {}

func (*Metric_TargetValueString) isMetric_TargetValue() {}
...
var file_evidence_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x11, 0x61, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x65,
	...
	0x72, 0x63, 0x65, 0x22, 0xde, 0x02, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12, 0x0e,
	...
	,
	...
	0x22, 0x27, 0x0a, 0x0d, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x73, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x1f, 0x0a, 0x05, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x61, 0x70,
...
func file_evidence_proto_init() {
	...
	file_evidence_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*Metric_TargetValueNum)(nil),
		(*Metric_TargetValueString)(nil),
	}
