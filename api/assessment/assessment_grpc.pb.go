...
type AssessmentClient interface {
	...
	AssessEvidenceStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AssessEvidenceRequest, AssessEvidencesResponse], error)
}
...
func (c *assessmentClient) AssessEvidenceStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AssessEvidenceRequest, AssessEvidencesResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Assessment_ServiceDesc.Streams[0], Assessment_AssessEvidenceStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type Assessment_AssessEvidenceStreamClient = grpc.BidiStreamingClient[AssessEvidenceRequest, AssessEvidencesResponse]
...
type AssessmentServer interface {
	...
	// Assesses stream of evidences sent by the discovery and returns a response
	// stream. Part of the public API. Not exposed as REST.
	AssessEvidenceStream(grpc.BidiStreamingServer[AssessEvidenceRequest, AssessEvidencesResponse]) error
...
func (UnimplementedAssessmentServer) CalculateCompliance(context.Context, *CalculateComplianceRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CalculateCompliance not implemented")
}
func (UnimplementedAssessmentServer) AssessEvidence(context.Context, *AssessEvidenceRequest) (*AssessEvidenceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AssessEvidence not implemented")
}
func (UnimplementedAssessmentServer) AssessEvidenceStream(grpc.BidiStreamingServer[AssessEvidenceRequest, AssessEvidencesResponse]) error {
	return status.Error(codes.Unimplemented, "method AssessEvidenceStream not implemented")
}
...
func _Assessment_AssessEvidenceStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AssessmentServer).AssessEvidenceStream(&grpc.GenericServerStream[AssessEvidenceRequest, AssessEvidencesResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Assessment_AssessEvidenceStreamServer = grpc.BidiStreamingServer[AssessEvidenceRequest, AssessEvidencesResponse]
...
var Assessment_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "AssessEvidenceStream",
			Handler:       _Assessment_AssessEvidenceStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
