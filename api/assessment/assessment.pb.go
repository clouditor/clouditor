...
type MetricData struct {
	...
	TargetValue *structpb.Value `protobuf:"bytes,1,opt,name=target_value,json=targetValue,proto3" json:"target_value,omitempty"` // target value, e.g. string, number, array, ...
	Operator    string          `protobuf:"bytes,2,opt,name=operator,proto3" json:"operator,omitempty"`                          // the operator, e.g. "=="
}
...
func (x *MetricData) GetTargetValue() *structpb.Value {
	if x != nil {
...
func (x *MetricData) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
var file_assessment_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0e, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e, 0x63,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3a, 0x0a, 0x18, 0x54, 0x72, 0x69, 0x67, 0x67,
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xbf, 0x02,
	...
	0x72, 0x69, 0x63, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x70, 0x6c,
	...
	0x70, 0x6c, 0x69, 0x61, 0x6e, 0x63, 0x65, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22,
	0x63, 0x0a, 0x0a, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x44, 0x61, 0x74, 0x61, 0x12, 0x39, 0x0a,
	...
	0x67, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x72,
	0x61, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6f, 0x70, 0x65, 0x72,
	0x61, 0x74, 0x6f, 0x72, 0x32, 0xc8, 0x03, 0x0a, 0x0a, 0x41, 0x73, 0x73, 0x65, 0x73, 0x73, 0x6d,
	...
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x8a, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74,
	...
	0x75, 0x6c, 0x74, 0x73, 0x12, 0x89, 0x01, 0x0a, 0x0e, 0x41, 0x73, 0x73, 0x65, 0x73, 0x73, 0x45,
	...
	0x12, 0x4d, 0x0a, 0x0f, 0x41, 0x73, 0x73, 0x65, 0x73, 0x73, 0x45, 0x76, 0x69, 0x64, 0x65, 0x6e,
...
var file_assessment_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_assessment_proto_goTypes = []interface{}{
	...
	(*MetricData)(nil),                    // 6: clouditor.MetricData
	(*evidence.Evidence)(nil),             // 7: clouditor.Evidence
...
var file_assessment_proto_depIdxs = []int32{
	...
	7,  // 1: clouditor.AssessEvidenceRequest.evidence:type_name -> clouditor.Evidence
	8,  // 2: clouditor.Result.timestamp:type_name -> google.protobuf.Timestamp
	6,  // 3: clouditor.Result.metric_data:type_name -> clouditor.MetricData
	9,  // 4: clouditor.MetricData.target_value:type_name -> google.protobuf.Value
	0,  // 5: clouditor.Assessment.TriggerAssessment:input_type -> clouditor.TriggerAssessmentRequest
	1,  // 6: clouditor.Assessment.ListAssessmentResults:input_type -> clouditor.ListAssessmentResultsRequest
	3,  // 7: clouditor.Assessment.AssessEvidence:input_type -> clouditor.AssessEvidenceRequest
	3,  // 8: clouditor.Assessment.AssessEvidences:input_type -> clouditor.AssessEvidenceRequest
	10, // 9: clouditor.Assessment.TriggerAssessment:output_type -> google.protobuf.Empty
	2,  // 10: clouditor.Assessment.ListAssessmentResults:output_type -> clouditor.ListAssessmentResultsResponse
	4,  // 11: clouditor.Assessment.AssessEvidence:output_type -> clouditor.AssessEvidenceResponse
	10, // 12: clouditor.Assessment.AssessEvidences:output_type -> google.protobuf.Empty
