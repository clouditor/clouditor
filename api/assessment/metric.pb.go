...
type Metric struct {
	...
	// Note: Golang uses as time.Duration the elapsed time between two time objects as an int64 nanosecond count. If time.Duration is used, the interval must be converted to nanoseconds.
