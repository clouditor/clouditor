...
type MetricConfiguration struct {
	...
	TargetOfEvaluationId string `protobuf:"bytes,6,opt,name=target_of_evaluation_id,json=targetOfCertificationId,proto3" json:"target_of_evaluation_id,omitempty" gorm:"primaryKey"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
