...
var (
	...
	ErrCertificationTargetIDIsMissing = errors.New("target of evaluation id is missing")
	ErrCertificationTargetIDIsInvalid = errors.New("target of evaluation id is invalid")
)
