...
var file_api_orchestrator_orchestrator_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x7b, 0x0a, 0x18,
	...
	0x49, 0x64, 0x22, 0x81, 0x02, 0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
	...
	,
	...
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x86, 0x1c, 0x0a, 0x0c, 0x4f, 0x72, 0x63, 0x68, 0x65,
...
var file_api_orchestrator_orchestrator_proto_depIdxs = []int32{
	...
	27, // 38: clouditor.Orchestrator.GetCertificate:input_type -> clouditor.GetCertificateRequest
	28, // 39: clouditor.Orchestrator.UpdateCertificate:input_type -> clouditor.UpdateCertificateRequest
	25, // 40: clouditor.Orchestrator.RegisterAssessmentTool:output_type -> clouditor.AssessmentTool
	2,  // 41: clouditor.Orchestrator.ListAssessmentTools:output_type -> clouditor.ListAssessmentToolsResponse
	25, // 42: clouditor.Orchestrator.GetAssessmentTool:output_type -> clouditor.AssessmentTool
	25, // 43: clouditor.Orchestrator.UpdateAssessmentTool:output_type -> clouditor.AssessmentTool
	38, // 44: clouditor.Orchestrator.DeregisterAssessmentTool:output_type -> google.protobuf.Empty
	7,  // 45: clouditor.Orchestrator.StoreAssessmentResult:output_type -> clouditor.StoreAssessmentResultResponse
	7,  // 46: clouditor.Orchestrator.StoreAssessmentResults:output_type -> clouditor.StoreAssessmentResultResponse
	39, // 47: clouditor.Orchestrator.ListAssessmentResults:output_type -> clouditor.ListAssessmentResultsResponse
	34, // 48: clouditor.Orchestrator.CreateMetric:output_type -> clouditor.Metric
	34, // 49: clouditor.Orchestrator.UpdateMetric:output_type -> clouditor.Metric
	34, // 50: clouditor.Orchestrator.GetMetric:output_type -> clouditor.Metric
	12, // 51: clouditor.Orchestrator.ListMetrics:output_type -> clouditor.ListMetricsResponse
	26, // 52: clouditor.Orchestrator.RegisterCloudService:output_type -> clouditor.CloudService
	26, // 53: clouditor.Orchestrator.UpdateCloudService:output_type -> clouditor.CloudService
	26, // 54: clouditor.Orchestrator.GetCloudService:output_type -> clouditor.CloudService
	18, // 55: clouditor.Orchestrator.ListCloudServices:output_type -> clouditor.ListCloudServicesResponse
	38, // 56: clouditor.Orchestrator.RemoveCloudService:output_type -> google.protobuf.Empty
	35, // 57: clouditor.Orchestrator.UpdateMetricConfiguration:output_type -> clouditor.MetricConfiguration
	35, // 58: clouditor.Orchestrator.GetMetricConfiguration:output_type -> clouditor.MetricConfiguration
	22, // 59: clouditor.Orchestrator.ListMetricConfigurations:output_type -> clouditor.ListMetricConfigurationResponse
	36, // 60: clouditor.Orchestrator.UpdateMetricImplementation:output_type -> clouditor.MetricImplementation
	36, // 61: clouditor.Orchestrator.GetMetricImplementation:output_type -> clouditor.MetricImplementation
	31, // 62: clouditor.Orchestrator.GetCertificate:output_type -> clouditor.Certificate
	31, // 63: clouditor.Orchestrator.UpdateCertificate:output_type -> clouditor.Certificate
