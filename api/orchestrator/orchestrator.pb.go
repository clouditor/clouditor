...
var file_api_orchestrator_orchestrator_proto_rawDesc = []byte{
	...
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xe5, 0x19, 0x0a,
	...
	0x69, 0x64, 0x7d, 0x12, 0xc0, 0x01, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x65,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x50, 0x1a, 0x4e, 0x2f, 0x76, 0x31, 0x2f, 0x6f, 0x72, 0x63, 0x68,
	...
	0x69, 0x63, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0xba, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4d, 0x65,
	0x74, 0x72, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x12, 0xb9, 0x01, 0x0a, 0x1b, 0x55, 0x70, 0x64, 0x64, 0x61, 0x74, 0x65, 0x4d,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x42, 0x29, 0x5a, 0x27, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x69, 0x74, 0x6f,
...
var file_api_orchestrator_orchestrator_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_api_orchestrator_orchestrator_proto_goTypes = []interface{}{
	...
	nil,                                              // 27: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry
	(*assessment.AssessmentResult)(nil),              // 28: clouditor.AssessmentResult
	(*assessment.Metric)(nil),                        // 29: clouditor.Metric
	(*assessment.MetricConfiguration)(nil),           // 30: clouditor.MetricConfiguration
	(*assessment.MetricImplementation)(nil),          // 31: clouditor.MetricImplementation
	(*assessment.ListAssessmentResultsRequest)(nil),  // 32: clouditor.ListAssessmentResultsRequest
	(*emptypb.Empty)(nil),                            // 33: google.protobuf.Empty
	(*assessment.ListAssessmentResultsResponse)(nil), // 34: clouditor.ListAssessmentResultsResponse
}
var file_api_orchestrator_orchestrator_proto_depIdxs = []int32{
	...
	28, // 3: clouditor.StoreAssessmentResultRequest.result:type_name -> clouditor.AssessmentResult
	29, // 4: clouditor.CreateMetricRequest.metric:type_name -> clouditor.Metric
	29, // 5: clouditor.UpdateMetricRequest.metric:type_name -> clouditor.Metric
	29, // 6: clouditor.ListMetricsResponse.metrics:type_name -> clouditor.Metric
	...
	30, // 10: clouditor.UpdateMetricConfigurationRequest.configuration:type_name -> clouditor.MetricConfiguration
	27, // 11: clouditor.ListMetricConfigurationResponse.configurations:type_name -> clouditor.ListMetricConfigurationResponse.ConfigurationsEntry
	31, // 12: clouditor.UpdateMetricImplementationRequest.implementation:type_name -> clouditor.MetricImplementation
	30, // 13: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry.value:type_name -> clouditor.MetricConfiguration
	0,  // 14: clouditor.Orchestrator.RegisterAssessmentTool:input_type -> clouditor.RegisterAssessmentToolRequest
	1,  // 15: clouditor.Orchestrator.ListAssessmentTools:input_type -> clouditor.ListAssessmentToolsRequest
	3,  // 16: clouditor.Orchestrator.GetAssessmentTool:input_type -> clouditor.GetAssessmentToolRequest
	4,  // 17: clouditor.Orchestrator.UpdateAssessmentTool:input_type -> clouditor.UpdateAssessmentToolRequest
	5,  // 18: clouditor.Orchestrator.DeregisterAssessmentTool:input_type -> clouditor.DeregisterAssessmentToolRequest
	6,  // 19: clouditor.Orchestrator.StoreAssessmentResult:input_type -> clouditor.StoreAssessmentResultRequest
	6,  // 20: clouditor.Orchestrator.StoreAssessmentResults:input_type -> clouditor.StoreAssessmentResultRequest
	32, // 21: clouditor.Orchestrator.ListAssessmentResults:input_type -> clouditor.ListAssessmentResultsRequest
	8,  // 22: clouditor.Orchestrator.CreateMetric:input_type -> clouditor.CreateMetricRequest
	9,  // 23: clouditor.Orchestrator.UpdateMetric:input_type -> clouditor.UpdateMetricRequest
	10, // 24: clouditor.Orchestrator.GetMetric:input_type -> clouditor.GetMetricRequest
	11, // 25: clouditor.Orchestrator.ListMetrics:input_type -> clouditor.ListMetricsRequest
	14, // 26: clouditor.Orchestrator.RegisterCloudService:input_type -> clouditor.RegisterCloudServiceRequest
	15, // 27: clouditor.Orchestrator.UpdateCloudService:input_type -> clouditor.UpdateCloudServiceRequest
	13, // 28: clouditor.Orchestrator.GetCloudService:input_type -> clouditor.GetCloudServiceRequest
	17, // 29: clouditor.Orchestrator.ListCloudServices:input_type -> clouditor.ListCloudServicesRequest
	16, // 30: clouditor.Orchestrator.RemoveCloudService:input_type -> clouditor.RemoveCloudServiceRequest
	19, // 31: clouditor.Orchestrator.UpdateMetricConfiguration:input_type -> clouditor.UpdateMetricConfigurationRequest
	20, // 32: clouditor.Orchestrator.GetMetricConfiguration:input_type -> clouditor.GetMetricConfigurationRequest
	21, // 33: clouditor.Orchestrator.ListMetricConfigurations:input_type -> clouditor.ListMetricConfigurationRequest
	23, // 34: clouditor.Orchestrator.UpddateMetricImplementation:input_type -> clouditor.UpdateMetricImplementationRequest
	24, // 35: clouditor.Orchestrator.GetMetricImplementation:input_type -> clouditor.GetMetricImplementationRequest
	25, // 36: clouditor.Orchestrator.RegisterAssessmentTool:output_type -> clouditor.AssessmentTool
	2,  // 37: clouditor.Orchestrator.ListAssessmentTools:output_type -> clouditor.ListAssessmentToolsResponse
	25, // 38: clouditor.Orchestrator.GetAssessmentTool:output_type -> clouditor.AssessmentTool
	25, // 39: clouditor.Orchestrator.UpdateAssessmentTool:output_type -> clouditor.AssessmentTool
	33, // 40: clouditor.Orchestrator.DeregisterAssessmentTool:output_type -> google.protobuf.Empty
	7,  // 41: clouditor.Orchestrator.StoreAssessmentResult:output_type -> clouditor.StoreAssessmentResultResponse
	7,  // 42: clouditor.Orchestrator.StoreAssessmentResults:output_type -> clouditor.StoreAssessmentResultResponse
	34, // 43: clouditor.Orchestrator.ListAssessmentResults:output_type -> clouditor.ListAssessmentResultsResponse
	29, // 44: clouditor.Orchestrator.CreateMetric:output_type -> clouditor.Metric
	29, // 45: clouditor.Orchestrator.UpdateMetric:output_type -> clouditor.Metric
	29, // 46: clouditor.Orchestrator.GetMetric:output_type -> clouditor.Metric
	12, // 47: clouditor.Orchestrator.ListMetrics:output_type -> clouditor.ListMetricsResponse
	26, // 48: clouditor.Orchestrator.RegisterCloudService:output_type -> clouditor.CloudService
	26, // 49: clouditor.Orchestrator.UpdateCloudService:output_type -> clouditor.CloudService
	26, // 50: clouditor.Orchestrator.GetCloudService:output_type -> clouditor.CloudService
	18, // 51: clouditor.Orchestrator.ListCloudServices:output_type -> clouditor.ListCloudServicesResponse
	33, // 52: clouditor.Orchestrator.RemoveCloudService:output_type -> google.protobuf.Empty
	30, // 53: clouditor.Orchestrator.UpdateMetricConfiguration:output_type -> clouditor.MetricConfiguration
	30, // 54: clouditor.Orchestrator.GetMetricConfiguration:output_type -> clouditor.MetricConfiguration
	22, // 55: clouditor.Orchestrator.ListMetricConfigurations:output_type -> clouditor.ListMetricConfigurationResponse
	31, // 56: clouditor.Orchestrator.UpddateMetricImplementation:output_type -> clouditor.MetricImplementation
	31, // 57: clouditor.Orchestrator.GetMetricImplementation:output_type -> clouditor.MetricImplementation
