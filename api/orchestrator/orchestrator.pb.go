...
var file_api_orchestrator_orchestrator_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x7b, 0x0a, 0x18, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x63, 0x61, 0x74, 0x65, 0x22, 0x54, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x65,
	0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x81, 0x02,
	0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x25, 0x0a,
	...
	0x09, 0x69, 0x73, 0x73, 0x75, 0x65, 0x64, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x69, 0x73, 0x73, 0x75, 0x65, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x73,
	...
	0x6e, 0x32, 0x8b, 0x1d, 0x0a, 0x0c, 0x4f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74,
	...
	0x70, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x82, 0x01, 0x0a,
	...
	0x7d, 0x12, 0x8b, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x65, 0x72, 0x74,
	0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x23, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x69,
	0x74, 0x6f, 0x72, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	...
	0x63, 0x61, 0x74, 0x65, 0x22, 0x39, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x33, 0x1a, 0x2e, 0x2f, 0x76,
	0x31, 0x2f, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x63,
	0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x2f, 0x7b, 0x63, 0x65, 0x72,
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x3a, 0x01, 0x2a, 0x42,
...
var file_api_orchestrator_orchestrator_proto_depIdxs = []int32{
	...
	30, // 41: clouditor.Orchestrator.GetCertificate:input_type -> clouditor.GetCertificateRequest
	31, // 42: clouditor.Orchestrator.UpdateCertificate:input_type -> clouditor.UpdateCertificateRequest
	27, // 43: clouditor.Orchestrator.RegisterAssessmentTool:output_type -> clouditor.AssessmentTool
	2,  // 44: clouditor.Orchestrator.ListAssessmentTools:output_type -> clouditor.ListAssessmentToolsResponse
	27, // 45: clouditor.Orchestrator.GetAssessmentTool:output_type -> clouditor.AssessmentTool
	27, // 46: clouditor.Orchestrator.UpdateAssessmentTool:output_type -> clouditor.AssessmentTool
	42, // 47: clouditor.Orchestrator.DeregisterAssessmentTool:output_type -> google.protobuf.Empty
	7,  // 48: clouditor.Orchestrator.StoreAssessmentResult:output_type -> clouditor.StoreAssessmentResultResponse
	7,  // 49: clouditor.Orchestrator.StoreAssessmentResults:output_type -> clouditor.StoreAssessmentResultResponse
	43, // 50: clouditor.Orchestrator.ListAssessmentResults:output_type -> clouditor.ListAssessmentResultsResponse
	38, // 51: clouditor.Orchestrator.CreateMetric:output_type -> clouditor.Metric
	38, // 52: clouditor.Orchestrator.UpdateMetric:output_type -> clouditor.Metric
	38, // 53: clouditor.Orchestrator.GetMetric:output_type -> clouditor.Metric
	12, // 54: clouditor.Orchestrator.ListMetrics:output_type -> clouditor.ListMetricsResponse
	14, // 55: clouditor.Orchestrator.ListRequirements:output_type -> clouditor.ListRequirementsResponse
	28, // 56: clouditor.Orchestrator.RegisterCloudService:output_type -> clouditor.CloudService
	28, // 57: clouditor.Orchestrator.UpdateCloudService:output_type -> clouditor.CloudService
	28, // 58: clouditor.Orchestrator.GetCloudService:output_type -> clouditor.CloudService
	20, // 59: clouditor.Orchestrator.ListCloudServices:output_type -> clouditor.ListCloudServicesResponse
	42, // 60: clouditor.Orchestrator.RemoveCloudService:output_type -> google.protobuf.Empty
	39, // 61: clouditor.Orchestrator.UpdateMetricConfiguration:output_type -> clouditor.MetricConfiguration
	39, // 62: clouditor.Orchestrator.GetMetricConfiguration:output_type -> clouditor.MetricConfiguration
	24, // 63: clouditor.Orchestrator.ListMetricConfigurations:output_type -> clouditor.ListMetricConfigurationResponse
	40, // 64: clouditor.Orchestrator.UpdateMetricImplementation:output_type -> clouditor.MetricImplementation
	40, // 65: clouditor.Orchestrator.GetMetricImplementation:output_type -> clouditor.MetricImplementation
	34, // 66: clouditor.Orchestrator.GetCertificate:output_type -> clouditor.Certificate
	34, // 67: clouditor.Orchestrator.UpdateCertificate:output_type -> clouditor.Certificate
