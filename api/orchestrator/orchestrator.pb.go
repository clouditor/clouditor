...
type CloudService struct {
	...
	Name                 string                            `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Description          string                            `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	MetricConfigurations []*assessment.MetricConfiguration `protobuf:"bytes,4,rep,name=metric_configurations,json=metricConfigurations,proto3" json:"metric_configurations,omitempty" gorm:"many2many:cloud_service_metric_configurations;References:service_id"`
}
