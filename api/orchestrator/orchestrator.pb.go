...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x65, 0x22, 0x30, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63,
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x74, 0x72,
	0x69, 0x63, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6d, 0x65, 0x74,
	...
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xaf, 0x13, 0x0a,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x28, 0x01, 0x12, 0x8a, 0x01, 0x0a,
	...
	0x18, 0x12, 0x16, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x73, 0x73, 0x6d, 0x65, 0x6e,
	0x74, 0x2f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x6a, 0x0a, 0x09, 0x47, 0x65, 0x74,
	...
	0x7d, 0x12, 0xba, 0x01, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x43,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x12,
	0x5a, 0x10, 0x61, 0x70, 0x69, 0x2f, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74,
...
var file_orchestrator_proto_goTypes = []interface{}{
	...
	(*GetCloudServiceRequest)(nil),                   // 11: clouditor.GetCloudServiceRequest
	(*RegisterCloudServiceRequest)(nil),              // 12: clouditor.RegisterCloudServiceRequest
	(*UpdateCloudServiceRequest)(nil),                // 13: clouditor.UpdateCloudServiceRequest
	(*RemoveCloudServiceRequest)(nil),                // 14: clouditor.RemoveCloudServiceRequest
	(*ListCloudServicesRequest)(nil),                 // 15: clouditor.ListCloudServicesRequest
	(*ListCloudServicesResponse)(nil),                // 16: clouditor.ListCloudServicesResponse
	(*GetMetricConfigurationRequest)(nil),            // 17: clouditor.GetMetricConfigurationRequest
	(*ListMetricConfigurationRequest)(nil),           // 18: clouditor.ListMetricConfigurationRequest
	(*ListMetricConfigurationResponse)(nil),          // 19: clouditor.ListMetricConfigurationResponse
	(*AssessmentTool)(nil),                           // 20: clouditor.AssessmentTool
	(*CloudService)(nil),                             // 21: clouditor.CloudService
	nil,                                              // 22: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry
	(*assessment.AssessmentResult)(nil),              // 23: clouditor.AssessmentResult
	(*assessment.Metric)(nil),                        // 24: clouditor.Metric
	(*assessment.MetricConfiguration)(nil),           // 25: clouditor.MetricConfiguration
	(*assessment.ListAssessmentResultsRequest)(nil),  // 26: clouditor.ListAssessmentResultsRequest
	(*emptypb.Empty)(nil),                            // 27: google.protobuf.Empty
	(*assessment.ListAssessmentResultsResponse)(nil), // 28: clouditor.ListAssessmentResultsResponse
}
var file_orchestrator_proto_depIdxs = []int32{
	20, // 0: clouditor.RegisterAssessmentToolRequest.tool:type_name -> clouditor.AssessmentTool
	20, // 1: clouditor.ListAssessmentToolsResponse.tools:type_name -> clouditor.AssessmentTool
	20, // 2: clouditor.UpdateAssessmentToolRequest.tool:type_name -> clouditor.AssessmentTool
	23, // 3: clouditor.StoreAssessmentResultRequest.result:type_name -> clouditor.AssessmentResult
	24, // 4: clouditor.ListMetricsResponse.metrics:type_name -> clouditor.Metric
	...
	22, // 8: clouditor.ListMetricConfigurationResponse.configurations:type_name -> clouditor.ListMetricConfigurationResponse.ConfigurationsEntry
	25, // 9: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry.value:type_name -> clouditor.MetricConfiguration
	0,  // 10: clouditor.Orchestrator.RegisterAssessmentTool:input_type -> clouditor.RegisterAssessmentToolRequest
	1,  // 11: clouditor.Orchestrator.ListAssessmentTools:input_type -> clouditor.ListAssessmentToolsRequest
	3,  // 12: clouditor.Orchestrator.GetAssessmentTool:input_type -> clouditor.GetAssessmentToolRequest
	4,  // 13: clouditor.Orchestrator.UpdateAssessmentTool:input_type -> clouditor.UpdateAssessmentToolRequest
	5,  // 14: clouditor.Orchestrator.DeregisterAssessmentTool:input_type -> clouditor.DeregisterAssessmentToolRequest
	6,  // 15: clouditor.Orchestrator.StoreAssessmentResult:input_type -> clouditor.StoreAssessmentResultRequest
	23, // 16: clouditor.Orchestrator.StoreAssessmentResults:input_type -> clouditor.AssessmentResult
	26, // 17: clouditor.Orchestrator.ListAssessmentResults:input_type -> clouditor.ListAssessmentResultsRequest
	8,  // 18: clouditor.Orchestrator.GetMetric:input_type -> clouditor.GetMetricsRequest
	9,  // 19: clouditor.Orchestrator.ListMetrics:input_type -> clouditor.ListMetricsRequest
	12, // 20: clouditor.Orchestrator.RegisterCloudService:input_type -> clouditor.RegisterCloudServiceRequest
	13, // 21: clouditor.Orchestrator.UpdateCloudService:input_type -> clouditor.UpdateCloudServiceRequest
	11, // 22: clouditor.Orchestrator.GetCloudService:input_type -> clouditor.GetCloudServiceRequest
	15, // 23: clouditor.Orchestrator.ListCloudServices:input_type -> clouditor.ListCloudServicesRequest
	14, // 24: clouditor.Orchestrator.RemoveCloudService:input_type -> clouditor.RemoveCloudServiceRequest
	17, // 25: clouditor.Orchestrator.GetMetricConfiguration:input_type -> clouditor.GetMetricConfigurationRequest
	18, // 26: clouditor.Orchestrator.ListMetricConfigurations:input_type -> clouditor.ListMetricConfigurationRequest
	20, // 27: clouditor.Orchestrator.RegisterAssessmentTool:output_type -> clouditor.AssessmentTool
	2,  // 28: clouditor.Orchestrator.ListAssessmentTools:output_type -> clouditor.ListAssessmentToolsResponse
	20, // 29: clouditor.Orchestrator.GetAssessmentTool:output_type -> clouditor.AssessmentTool
	20, // 30: clouditor.Orchestrator.UpdateAssessmentTool:output_type -> clouditor.AssessmentTool
	27, // 31: clouditor.Orchestrator.DeregisterAssessmentTool:output_type -> google.protobuf.Empty
	7,  // 32: clouditor.Orchestrator.StoreAssessmentResult:output_type -> clouditor.StoreAssessmentResultResponse
	27, // 33: clouditor.Orchestrator.StoreAssessmentResults:output_type -> google.protobuf.Empty
	28, // 34: clouditor.Orchestrator.ListAssessmentResults:output_type -> clouditor.ListAssessmentResultsResponse
	24, // 35: clouditor.Orchestrator.GetMetric:output_type -> clouditor.Metric
	10, // 36: clouditor.Orchestrator.ListMetrics:output_type -> clouditor.ListMetricsResponse
	21, // 37: clouditor.Orchestrator.RegisterCloudService:output_type -> clouditor.CloudService
	21, // 38: clouditor.Orchestrator.UpdateCloudService:output_type -> clouditor.CloudService
	21, // 39: clouditor.Orchestrator.GetCloudService:output_type -> clouditor.CloudService
	16, // 40: clouditor.Orchestrator.ListCloudServices:output_type -> clouditor.ListCloudServicesResponse
	27, // 41: clouditor.Orchestrator.RemoveCloudService:output_type -> google.protobuf.Empty
	25, // 42: clouditor.Orchestrator.GetMetricConfiguration:output_type -> clouditor.MetricConfiguration
	19, // 43: clouditor.Orchestrator.ListMetricConfigurations:output_type -> clouditor.ListMetricConfigurationResponse
