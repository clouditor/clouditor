...
var file_api_orchestrator_orchestrator_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x49, 0x64, 0x73, 0x32, 0xe7,
	0x1b, 0x0a, 0x0c, 0x4f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12,
	...
	0x76, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x30, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x63, 0x6c, 0x6f, 0x75,
...
var file_api_orchestrator_orchestrator_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_api_orchestrator_orchestrator_proto_goTypes = []interface{}{
	...
	nil,                                              // 33: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry
	(*CloudService_Requirements)(nil),                // 34: clouditor.CloudService.Requirements
	(*assessment.AssessmentResult)(nil),              // 35: clouditor.AssessmentResult
	(*assessment.Metric)(nil),                        // 36: clouditor.Metric
	(*assessment.MetricConfiguration)(nil),           // 37: clouditor.MetricConfiguration
	(*assessment.MetricImplementation)(nil),          // 38: clouditor.MetricImplementation
	(*assessment.ListAssessmentResultsRequest)(nil),  // 39: clouditor.ListAssessmentResultsRequest
	(*emptypb.Empty)(nil),                            // 40: google.protobuf.Empty
	(*assessment.ListAssessmentResultsResponse)(nil), // 41: clouditor.ListAssessmentResultsResponse
}
var file_api_orchestrator_orchestrator_proto_depIdxs = []int32{
	...
	35, // 3: clouditor.StoreAssessmentResultRequest.result:type_name -> clouditor.AssessmentResult
	36, // 4: clouditor.CreateMetricRequest.metric:type_name -> clouditor.Metric
	36, // 5: clouditor.UpdateMetricRequest.metric:type_name -> clouditor.Metric
	36, // 6: clouditor.ListMetricsResponse.metrics:type_name -> clouditor.Metric
	...
	37, // 11: clouditor.UpdateMetricConfigurationRequest.configuration:type_name -> clouditor.MetricConfiguration
	33, // 12: clouditor.ListMetricConfigurationResponse.configurations:type_name -> clouditor.ListMetricConfigurationResponse.ConfigurationsEntry
	38, // 13: clouditor.UpdateMetricImplementationRequest.implementation:type_name -> clouditor.MetricImplementation
	0,  // 14: clouditor.MetricChangeEvent.type:type_name -> clouditor.MetricChangeEvent.Type
	34, // 15: clouditor.CloudService.requirements:type_name -> clouditor.CloudService.Requirements
	37, // 16: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry.value:type_name -> clouditor.MetricConfiguration
	1,  // 17: clouditor.Orchestrator.RegisterAssessmentTool:input_type -> clouditor.RegisterAssessmentToolRequest
	2,  // 18: clouditor.Orchestrator.ListAssessmentTools:input_type -> clouditor.ListAssessmentToolsRequest
	4,  // 19: clouditor.Orchestrator.GetAssessmentTool:input_type -> clouditor.GetAssessmentToolRequest
	5,  // 20: clouditor.Orchestrator.UpdateAssessmentTool:input_type -> clouditor.UpdateAssessmentToolRequest
	6,  // 21: clouditor.Orchestrator.DeregisterAssessmentTool:input_type -> clouditor.DeregisterAssessmentToolRequest
	7,  // 22: clouditor.Orchestrator.StoreAssessmentResult:input_type -> clouditor.StoreAssessmentResultRequest
	7,  // 23: clouditor.Orchestrator.StoreAssessmentResults:input_type -> clouditor.StoreAssessmentResultRequest
	39, // 24: clouditor.Orchestrator.ListAssessmentResults:input_type -> clouditor.ListAssessmentResultsRequest
	9,  // 25: clouditor.Orchestrator.CreateMetric:input_type -> clouditor.CreateMetricRequest
	10, // 26: clouditor.Orchestrator.UpdateMetric:input_type -> clouditor.UpdateMetricRequest
	11, // 27: clouditor.Orchestrator.GetMetric:input_type -> clouditor.GetMetricRequest
	12, // 28: clouditor.Orchestrator.ListMetrics:input_type -> clouditor.ListMetricsRequest
	14, // 29: clouditor.Orchestrator.ListRequirements:input_type -> clouditor.ListRequirementsRequest
	17, // 30: clouditor.Orchestrator.RegisterCloudService:input_type -> clouditor.RegisterCloudServiceRequest
	18, // 31: clouditor.Orchestrator.UpdateCloudService:input_type -> clouditor.UpdateCloudServiceRequest
	16, // 32: clouditor.Orchestrator.GetCloudService:input_type -> clouditor.GetCloudServiceRequest
	20, // 33: clouditor.Orchestrator.ListCloudServices:input_type -> clouditor.ListCloudServicesRequest
	19, // 34: clouditor.Orchestrator.RemoveCloudService:input_type -> clouditor.RemoveCloudServiceRequest
	22, // 35: clouditor.Orchestrator.UpdateMetricConfiguration:input_type -> clouditor.UpdateMetricConfigurationRequest
	23, // 36: clouditor.Orchestrator.GetMetricConfiguration:input_type -> clouditor.GetMetricConfigurationRequest
	24, // 37: clouditor.Orchestrator.ListMetricConfigurations:input_type -> clouditor.ListMetricConfigurationRequest
	26, // 38: clouditor.Orchestrator.UpdateMetricImplementation:input_type -> clouditor.UpdateMetricImplementationRequest
	27, // 39: clouditor.Orchestrator.GetMetricImplementation:input_type -> clouditor.GetMetricImplementationRequest
	28, // 40: clouditor.Orchestrator.SubscribeMetricChangeEvents:input_type -> clouditor.SubscribeMetricChangeEventRequest
	30, // 41: clouditor.Orchestrator.RegisterAssessmentTool:output_type -> clouditor.AssessmentTool
	3,  // 42: clouditor.Orchestrator.ListAssessmentTools:output_type -> clouditor.ListAssessmentToolsResponse
	30, // 43: clouditor.Orchestrator.GetAssessmentTool:output_type -> clouditor.AssessmentTool
	30, // 44: clouditor.Orchestrator.UpdateAssessmentTool:output_type -> clouditor.AssessmentTool
	40, // 45: clouditor.Orchestrator.DeregisterAssessmentTool:output_type -> google.protobuf.Empty
	8,  // 46: clouditor.Orchestrator.StoreAssessmentResult:output_type -> clouditor.StoreAssessmentResultResponse
	8,  // 47: clouditor.Orchestrator.StoreAssessmentResults:output_type -> clouditor.StoreAssessmentResultResponse
	41, // 48: clouditor.Orchestrator.ListAssessmentResults:output_type -> clouditor.ListAssessmentResultsResponse
	36, // 49: clouditor.Orchestrator.CreateMetric:output_type -> clouditor.Metric
	36, // 50: clouditor.Orchestrator.UpdateMetric:output_type -> clouditor.Metric
	36, // 51: clouditor.Orchestrator.GetMetric:output_type -> clouditor.Metric
	13, // 52: clouditor.Orchestrator.ListMetrics:output_type -> clouditor.ListMetricsResponse
	15, // 53: clouditor.Orchestrator.ListRequirements:output_type -> clouditor.ListRequirementsResponse
	31, // 54: clouditor.Orchestrator.RegisterCloudService:output_type -> clouditor.CloudService
	31, // 55: clouditor.Orchestrator.UpdateCloudService:output_type -> clouditor.CloudService
	31, // 56: clouditor.Orchestrator.GetCloudService:output_type -> clouditor.CloudService
	21, // 57: clouditor.Orchestrator.ListCloudServices:output_type -> clouditor.ListCloudServicesResponse
	40, // 58: clouditor.Orchestrator.RemoveCloudService:output_type -> google.protobuf.Empty
	37, // 59: clouditor.Orchestrator.UpdateMetricConfiguration:output_type -> clouditor.MetricConfiguration
	37, // 60: clouditor.Orchestrator.GetMetricConfiguration:output_type -> clouditor.MetricConfiguration
	25, // 61: clouditor.Orchestrator.ListMetricConfigurations:output_type -> clouditor.ListMetricConfigurationResponse
	38, // 62: clouditor.Orchestrator.UpdateMetricImplementation:output_type -> clouditor.MetricImplementation
	38, // 63: clouditor.Orchestrator.GetMetricImplementation:output_type -> clouditor.MetricImplementation
	29, // 64: clouditor.Orchestrator.SubscribeMetricChangeEvents:output_type -> clouditor.MetricChangeEvent
