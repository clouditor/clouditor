...
var file_api_orchestrator_orchestrator_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x73, 0x22, 0x72, 0x0a, 0x0b, 0x52, 0x65,
	...
	0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x49, 0x64, 0x73, 0x22, 0x3e,
	...
	0x0d, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x55,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x7e, 0x0a, 0x18, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x65, 0x72,
...
var file_api_orchestrator_orchestrator_proto_depIdxs = []int32{
	...
	39, // 16: clouditor.ListCertificatesResponse.certificates:type_name -> clouditor.Certificate
	39, // 17: clouditor.UpdateCertificateRequest.certificate:type_name -> clouditor.Certificate
	39, // 18: clouditor.CreateCertificateRequest.certificate:type_name -> clouditor.Certificate
	40, // 19: clouditor.Certificate.states:type_name -> clouditor.State
	45, // 20: clouditor.ListMetricConfigurationResponse.ConfigurationsEntry.value:type_name -> clouditor.MetricConfiguration
	1,  // 21: clouditor.Orchestrator.RegisterAssessmentTool:input_type -> clouditor.RegisterAssessmentToolRequest
	2,  // 22: clouditor.Orchestrator.ListAssessmentTools:input_type -> clouditor.ListAssessmentToolsRequest
	4,  // 23: clouditor.Orchestrator.GetAssessmentTool:input_type -> clouditor.GetAssessmentToolRequest
	5,  // 24: clouditor.Orchestrator.UpdateAssessmentTool:input_type -> clouditor.UpdateAssessmentToolRequest
	6,  // 25: clouditor.Orchestrator.DeregisterAssessmentTool:input_type -> clouditor.DeregisterAssessmentToolRequest
	7,  // 26: clouditor.Orchestrator.StoreAssessmentResult:input_type -> clouditor.StoreAssessmentResultRequest
	7,  // 27: clouditor.Orchestrator.StoreAssessmentResults:input_type -> clouditor.StoreAssessmentResultRequest
	47, // 28: clouditor.Orchestrator.ListAssessmentResults:input_type -> clouditor.ListAssessmentResultsRequest
	9,  // 29: clouditor.Orchestrator.CreateMetric:input_type -> clouditor.CreateMetricRequest
	10, // 30: clouditor.Orchestrator.UpdateMetric:input_type -> clouditor.UpdateMetricRequest
	11, // 31: clouditor.Orchestrator.GetMetric:input_type -> clouditor.GetMetricRequest
	12, // 32: clouditor.Orchestrator.ListMetrics:input_type -> clouditor.ListMetricsRequest
	14, // 33: clouditor.Orchestrator.ListRequirements:input_type -> clouditor.ListRequirementsRequest
	17, // 34: clouditor.Orchestrator.RegisterCloudService:input_type -> clouditor.RegisterCloudServiceRequest
	18, // 35: clouditor.Orchestrator.UpdateCloudService:input_type -> clouditor.UpdateCloudServiceRequest
	16, // 36: clouditor.Orchestrator.GetCloudService:input_type -> clouditor.GetCloudServiceRequest
	20, // 37: clouditor.Orchestrator.ListCloudServices:input_type -> clouditor.ListCloudServicesRequest
	19, // 38: clouditor.Orchestrator.RemoveCloudService:input_type -> clouditor.RemoveCloudServiceRequest
	22, // 39: clouditor.Orchestrator.UpdateMetricConfiguration:input_type -> clouditor.UpdateMetricConfigurationRequest
	23, // 40: clouditor.Orchestrator.GetMetricConfiguration:input_type -> clouditor.GetMetricConfigurationRequest
	24, // 41: clouditor.Orchestrator.ListMetricConfigurations:input_type -> clouditor.ListMetricConfigurationRequest
	26, // 42: clouditor.Orchestrator.UpdateMetricImplementation:input_type -> clouditor.UpdateMetricImplementationRequest
	27, // 43: clouditor.Orchestrator.GetMetricImplementation:input_type -> clouditor.GetMetricImplementationRequest
	28, // 44: clouditor.Orchestrator.SubscribeMetricChangeEvents:input_type -> clouditor.SubscribeMetricChangeEventRequest
	37, // 45: clouditor.Orchestrator.CreateCertificate:input_type -> clouditor.CreateCertificateRequest
	...
	39, // 74: clouditor.Orchestrator.CreateCertificate:output_type -> clouditor.Certificate
