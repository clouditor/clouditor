...
var filter_Evaluation_StartEvaluation_0 = &utilities.DoubleArray{Encoding: map[string]int{"certification_target_id": 0, "catalog_id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
