...
const (
	...
	TargetOfEvaluationIDFlag                 = "certification-target-id"
	...
	CreateDefaultTargetOfEvaluationFlag      = "create-default-certification-target"
	DefaultTargetOfEvaluationNameFlag        = "default-certification-target-name"
	DefaultTargetOfEvaluationDescriptionFlag = "default-certification-target-description"
	DefaultTargetOfEvaluationTypeFlag        = "default-certification-target-type"
