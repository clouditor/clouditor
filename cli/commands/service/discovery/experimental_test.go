...
func TestNewUpdateResourceCommand(t *testing.T) {
	...
	err = cmd.RunE(nil, []string{`{"id": "MyApplication", "targetOfCertificationId": "00000000-0000-0000-0000-000000000000", "toolId":"test collector id", "resourceType": "Application,Resource", "properties":{"@type":"type.googleapis.com/clouditor.ontology.v1.Application", "id": "MyApplication", "name": "MyApplication"}}`})
	assert.NoError(t, err)
