...
public class HibernateUtils {
     ...
     * @throws IllegalStateException if the session factory was not initialized by one of the init functions.
     */
    ...
    /**
     * Connects Hibernate to the persistent PostgreSQL database
     * at the address: "jdbc:postgresql://{host}:{port}/{dbName}".
     *
     ...
     * @throws NullPointerException if <code>host</code>, <code>dbName</code>, <code>userName</code> or <code>password</code> is null.
     */
    public static void init(
            ...
            final String password) throws IllegalArgumentException, NullPointerException {
        Objects.requireNonNull(host);
        Objects.requireNonNull(dbName);
        Objects.requireNonNull(userName);
        Objects.requireNonNull(password);
        if (port < 1024 || port > 49151) throw new IllegalArgumentException(
     ...
     * @param password the password of the user
     * @throws IllegalArgumentException if the <code>port</code> is not in range [1024; 49151].
     * @throws NullPointerException if <code>dbName</code>, <code>userName</code> or <code>password</code> is null.
     */
