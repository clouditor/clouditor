...
public class CertificationResourceTest extends JerseyTest {
  ...
  /*
  When no certifications are available, test if
  - status of HTTP request is OK
  - content type is APPLICATION_JSON
  - content is empty
   */
  @Test
  public void
  ...
  /*
   * ToDo: The first if condition cannot be evaluated to true since getCertification(cert) would do it before
   *  ToDo: Is it possible to catch exception in called method?
   */
  @Test
